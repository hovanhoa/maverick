...
type ComplexityRoot struct {
	Mutation struct {
		CreateNote func(childComplexity int, req model.CreateNoteRequest) int
...
type MutationResolver interface {
	CreateNote(ctx context.Context, req model.CreateNoteRequest) (model.Note, error)
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.createNote":
		...
		return e.complexity.Mutation.CreateNote(childComplexity, args["req"].(model.CreateNoteRequest)), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		ec.unmarshalInputCreateNoteRequest,
	)
	first := true
...
func (ec *executionContext) field_Mutation_createNote_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Mutation_createNote_argsReq(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["req"] = arg0
...
func (ec *executionContext) field_Mutation_createNote_argsReq(
	ctx context.Context,
	rawArgs map[string]any,
) (model.CreateNoteRequest, error) {
...
func (ec *executionContext) _Mutation_createNote(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		...
		return ec.resolvers.Mutation().CreateNote(rctx, fc.Args["req"].(model.CreateNoteRequest))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Note_description(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Note",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) unmarshalInputCreateNoteRequest(ctx context.Context, obj any) (model.CreateNoteRequest, error) {
	var it model.CreateNoteRequest
